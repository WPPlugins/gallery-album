		...
		return array(
			"theme_general_settings"=>array(
				...
				"params"=>array(
					...
					"count_of_added_elements"=>array(
						...
						"description"=>"Select the count of added elements, this option work only when more button enabled",				
						"function_name"=>"simple_input",
						"type"=>"number",	
						"default_value"=>"20",
						"pro"=>true,
					...
					"hover_image_or_text_bar"=>array(
						...
						"values"=>array(":hover"=>"When whole element is on hover",""=>"When only text element is on hover"),
						"function_name"=>"simple_select",
						"default_value"=>":hover",
						"pro"=>true,
					),
			...
			"theme_pagination_settings"=>array(
				...
				"params"=>array(					
					...
					"more_page"=>array(
						...
						"values"=>array("0"=>"More button","1"=>"Pagination bar"),
						"function_name"=>"simple_select",
						"default_value"=>"1",
						"pro"=>true,
					),
			...
			"theme_image_settings"=>array(
				...
				"params"=>array(					
					...
					"image_quality"=>array(
						"title"=>"choose original or cropped image in popup",
...
/*############  Update gallery ID function  ################*/
	...
	private function display_table_list_theme(){
        ...
        <div class="wrap">
			...
			<h2>Gallery Themes <a href="admin.php?page=wpdevart_gallery_themes&task=add_wpda_galltheme" class="add-new-h2">Add New</a></h2>            
...
jQuery(document).ready(function(e) {
	...
	private function generete_theme_parametrs($id=0){
		global $wpdb;		
		if($id){
			$theme_params = $wpdb->get_row('SELECT * FROM '.wpdevart_gallery_databese::$table_names['theme'].' WHERE id='.$id);	
		}else{
