	...
	tinymce.PluginManager.add('wpdevart_gallery', function( editor, url ) {
		...
		editor.addCommand('wpdevart_gallery_popup', function() {
			...
			xxx0 = {
				...
				file:  document.location.origin+ajaxurl + '/?action=wpdevart_gallery_post_page_content&gallery_id='+getAttr(title,'gallery_id')+'&album_id='+getAttr(title,'album_id')+'&theme_id='+getAttr(title,'theme_id')+'&order_type='+getAttr(title,'order_type')+'&lost_ids='+getAttr(title,'lost_ids'),    
				width: 600, 
				height: 600,   
